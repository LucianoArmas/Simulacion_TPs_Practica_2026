...
tp2_1.py
========
TP 2.1 - Generadores de numeros pseudoaleatorios
Simulacion - UTN FRRO

Archivo unico autocontenido. Incluye:
    - Cuatro generadores: GCL, RANDU, Cuadrados Medios y Python (Mersenne Twister).
    - Cinco pruebas estadisticas: chi-cuadrado, Kolmogorov-Smirnov, rachas, poker y autocorrelacion.
    - Orquestacion: ejecuta las pruebas, imprime/guarda resultados y genera las figuras del informe.
